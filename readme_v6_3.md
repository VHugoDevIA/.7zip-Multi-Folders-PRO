# ZIP Múltiplas Pastas - PRO v6.3

**Alterações nesta versão (v6.3):**  
- Melhorias na gestão de ficheiros e interface, incluindo opções avançadas de compressão como método, tamanho do dicionário, tamanho da palavra e bloco sólido para 7Z.  
- Ajustes na construção de argumentos para o 7-Zip para suportar mais parâmetros personalizados.
...
2. Execute o script `zip_multiplas_pastas_pro_v6_3.ps1` com PowerShell.  
