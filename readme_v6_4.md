# ZIP Múltiplas Pastas - PRO v6.4

**Alterações nesta versão (v6.4):**  
- Adiciona suporte a mais opções de encriptação e validações.  
- Melhorias na função de remoção de arquivos criados, com tentativas múltiplas para lidar com ficheiros bloqueados.
...
2. Execute o script `zip_multiplas_pastas_pro_v6_4.ps1` com PowerShell.  
