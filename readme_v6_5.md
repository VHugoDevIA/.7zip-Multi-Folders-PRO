# ZIP Múltiplas Pastas - PRO v6.5

**Alterações nesta versão (v6.5):**  
- Melhorias no log e tratamento de erros, incluindo melhor feedback de progresso e gestão de exceções.
...
2. Execute o script `zip_multiplas_pastas_pro_v6_5.ps1` com PowerShell.  
