# ZIP Múltiplas Pastas - PRO v6.6.2

**Alterações nesta versão (v6.6.2):**  
- Atualizações na interface e compatibilidade, incluindo melhor suporte a diferentes versões do Windows e ajustes visuais.
...
2. Execute o script `zip_multiplas_pastas_pro_v6_6_2.ps1` com PowerShell.  
