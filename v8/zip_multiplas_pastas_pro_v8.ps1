...
$AppTitle = "ZIP Multiplas Pasta - PRO v8"
$MailSubject = "ZIP Multiplas Pasta - PRO v8"
$StateFile = Join-Path -Path $env:APPDATA -ChildPath "VHugoDevIA\zip_multiplas_pastas_pro_v8_state.json"
