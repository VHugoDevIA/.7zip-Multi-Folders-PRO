...
function Build-SevenZipArguments {
    ...
    if (-not [string]::IsNullOrWhiteSpace($VolumeSize)) {
        $args.Add("-v$($VolumeSize.Trim())")
    }

    if (($Format -eq "7z") -and $CreateSfx) {
        $args.Add("-sfx")
    }
    ...
    if ($Format -eq "zip") {
        ...
        # Para ZIP + Deflate / Deflate64 / BZip2 / PPMd / LZMA:
        # nem todas as combinacoes aceitam os mesmos switches.
        # O problema encontrado foi com -md=32k em Deflate.
        # Portanto:
        # - Deflate / Deflate64 -> permitir apenas fast bytes (mfb)
        # - BZip2 / LZMA / PPMd -> permitir md e mfb quando fizer sentido
...
$form.Text = "ZIP multiplas pastas - Pro v4"
...
$btnClearLog.Location = New-Object System.Drawing.Point(440, 45)
...
$listBox.Size = New-Object System.Drawing.Size(1020, 130)
...
$grpMain.Location = New-Object System.Drawing.Point(20, 240)
...
$grpEnc.Location = New-Object System.Drawing.Point(540, 240)
...
$grpExtra.Location = New-Object System.Drawing.Point(20, 485)
...
$progressFolder.Location = New-Object System.Drawing.Point(20, 605)
...
$lblTotal.Location = New-Object System.Drawing.Point(20, 635)
...
$progressTotal.Location = New-Object System.Drawing.Point(20, 660)
...
$txtLog.Location = New-Object System.Drawing.Point(20, 695)
...
function Update-FormatOptions {
    ...
    if ($format -eq "zip") {
        ...
        $cmbMethod.SelectedItem = "Automatico"
        $cmbDict.SelectedItem = "Automatico"
        $cmbWord.SelectedItem = "Automatico"
