...
$AppTitle = "ZIP multiplas pastas - Pro v6.1"
$MailSubject = "ZIP multiplas pasta - Pro v6.1"
...
function Start-NewProcessingLog {
    ...
    try {
        ...
        "=== LOG DE PROCESSAMENTO ===" | Set-Content -LiteralPath $script:CurrentLogFile -Encoding UTF8
        "Criado em: $(Get-Date -Format 'dd-MM-yyyy HH:mm:ss')" | Add-Content -LiteralPath $script:CurrentLogFile -Encoding UTF8
        "----------------------------------------" | Add-Content -LiteralPath $script:CurrentLogFile -Encoding UTF8
    }
    catch {
        $script:CurrentLogFile = $null
    }
...
$btnCancel.Location = New-Object System.Drawing.Point(800, 68)
...
$lblUpdateMode.Text = "Se o ZIP ja existir:"
...
$linkEmail.Add_LinkClicked({
    Start-Process "mailto:VHugoDevIA@gmail.com?subject=ZIP%20m%C3%BAltiplas%20pasta%20-%20Pro%20v6.1"
})
...
$btnOptions.Add_Click({
    ...
    $chkOpenLog.Text = "Abrir pasta do log no final das operacoes"
    ...
    $chkConfirmClear.Text = "Pedir confirmacao ao limpar lista"
    ...
    $lblInfo.Text = "Estas opcoes tambem ficam guardadas na ultima sessao."
    ...
    $btnCancel = New-Object System.Windows.Forms.Button
    $btnCancel.Text = "Cancelar"
    $btnCancel.Location = New-Object System.Drawing.Point(305, 155)
    $btnCancel.Size = New-Object System.Drawing.Size(75, 30)
    $btnCancel.DialogResult = [System.Windows.Forms.DialogResult]::Cancel
    $optForm.Controls.Add($btnCancel)

    $optForm.AcceptButton = $btnOk
    $optForm.CancelButton = $btnCancel
...
$btnCancel.Add_Click({
    ...
    Add-LogLine -TextBox $txtLog -Text "[CANCELAR] Pedido de cancelamento recebido."
    ...
    try {
        ...
        Add-LogLine -TextBox $txtLog -Text "[ERRO] Nao foi possivel cancelar imediatamente: $($_.Exception.Message)"
    }
})
