...
$AppTitle = "ZIP Multiplas Pasta - PRO v6.6"
$MailSubject = "ZIP Multiplas Pasta - PRO v6.6"
$StateFile = Join-Path -Path $env:APPDATA -ChildPath "VHugoDevIA\zip_multiplas_pastas_pro_v6_6_state.json"
